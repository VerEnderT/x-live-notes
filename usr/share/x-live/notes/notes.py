    ...
    def show_about_dialog(self):
        ...
        if language.startswith("de"):
            ...
            text = (f"X-Live Notes<br><br>"
                    ...
                    f"Webseite: <a href='https://github.com/verendert/'>https://github.com/verendert/x-live-notes</a><br>"
            ...
            text = (f"X-Live Notes<br><br>"
                    ...
                    f"Website: <a href='https://github.com/verendert'>https://github.com/verendert/x-live-notes</a><br>"
                    f"Version: {version}<br><br>"
                    f"Copyright © 2024 VerEnderT<br>"
